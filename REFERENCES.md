...
- [Qiskit Target](https://quantum.cloud.ibm.com/docs/en/api/qiskit/2.3/qiskit.transpiler.Target) — IBM Quantum, Qiskit 2.3. Used for: target-owned operation, qargs, coupling, angle-bound, and instruction-property constraints used by conservative BackendV2 hardware-capability translation and hardware compilation architecture comparison.
...
- [Simulation of electronic structure Hamiltonians using quantum computers](https://arxiv.org/abs/1001.3855) — James D. Whitfield, Jacob Biamonte, and Alán Aspuru-Guzik (2011). Used for: second-quantized electronic Hamiltonian structure, Jordan-Wigner fermion-to-qubit mapping, Pauli-string basis changes, parity accumulation, and exponentiation patterns for Hamiltonian simulation.
- [Strategies for quantum computing molecular energies using the unitary coupled cluster ansatz](https://arxiv.org/abs/1701.02691) - Jonathan Romero, Ryan Babbush, Jarrod R. McClean, Cornelius Hempel, Peter Love, and Alan Aspuru-Guzik (2018). Used for: unitary coupled-cluster molecular ansatz structure, occupied-to-virtual excitation operators, factorized excitation evolution, and variational chemistry workflows.
...
- [Quantum LDPC Codes With Positive Rate and Minimum Distance Proportional to the Square Root of the Blocklength](https://doi.org/10.1109/TIT.2013.2292061) — Jean-Pierre Tillich and Gilles Zémor, IEEE Transactions on Information Theory 60(2), 1193-1202 (2014). Used for: hypergraph-product CSS construction and finite-rate quantum-LDPC benchmark families.
...
- [LDPC: Software for Decoding Classical and Quantum Codes](https://github.com/quantumgizmos/ldpc) — Quantum Gizmos, LDPC 2.4.1. Used for: independent benchmark-only product-sum belief-propagation plus OSD-0 comparison on hypergraph-product code-capacity workloads.
